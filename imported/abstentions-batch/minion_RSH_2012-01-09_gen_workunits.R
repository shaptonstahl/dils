...
workunits <- data.frame(legislature=201, one.legislature)
for(i in 202:400)  workunits <- rbind(workunits, data.frame(legislature=i, one.legislature))
...
save(workunits, file="../batch/minion_RSH_2012-01-09_workunits.RData")
# nrow(workunits)
